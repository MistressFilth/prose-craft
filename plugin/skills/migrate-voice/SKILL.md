...
> mkdir -p /Users/dnova/.claude/plugins/data/prose/voices/.backups/${TS}-migrate-<voice>
> cp -r /Users/dnova/.claude/plugins/data/prose/voices/<voice> \
>   /Users/dnova/.claude/plugins/data/prose/voices/.backups/${TS}-migrate-<voice>/
> ```
>
