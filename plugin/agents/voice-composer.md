...
The 16 mood voices in the discordian family ship as worked examples. The writer can read any of them at `/Users/dnova/.claude/plugins/data/prose/voices/discordian-<mood>/voice.md` for reference.
